      ...
      axios.put(`http://localhost:8000/api/document-requests/${docId}/reject`, { status: 'rejected' })
        ...
        if (documents.length === 0) {
          ...
          <div className="card-body">
            ...
            <p className="card-text">Actually there's No current Request , try to refresh the Page or check later.</p>
            <a onClick={() => window.location.reload()} className="btn btn-primary">Refresh</a>
          </div>
